...
class LRU:
    ...
    def put(self,key,value):
        ...
        #print(f'Next node is: {tempNode.data}')
        self.head.next = newNode
        #print(f'New Next node is {self.head.next.data}')
        newNode.next = tempNode
        #print(f'Next to Next node is {self.head.next.next.data}')
...
'''print('Cache now is: ')
lru_cache.display()'''
#print('key1:',lru_cache.get(1))
#print('key2:',lru_cache.get(2))
